...
def process_control():
    ...
    if 'num_clients' in cfg['control']:
        ...
        cfg['labeled_data_split_mode'] = cfg['control']['labeled_data_split_mode']
        cfg['unlabeled_data_split_mode'] = cfg['control']['unlabeled_data_split_mode']
        ...
        cfg['client']['batch_size'] = {'train': 64, 'test': 250}
...
def make_optimizer(parameters, tag='local'):
    if tag == 'local':
